public class Map {
    ...
    public Map() {
        ...
        room2.addItem(new Item("dagger", " A worn dagger suitable for close combat in dark dungeons."));
        ...
        room4.addItem(new Food("fish", "delicius fresh fisk from the cave", 60));
        ...
        room9.addItem(new Food("juice", "jucie from a old monkey,", -20));
